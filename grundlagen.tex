...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{Pattern_CNa.png}
	\begin{flushright}
			\flushbottom{Quelle: \cite{zellform}}
	\end{flushright}
...
Die erste Stufe besitzt eine Länge von $7,37$ m und einen Durchmesser von $1,1$ m. Die Außenhülle soll aus Edelstahl gefertigt werden, somit hätte diese Stufe voll betankt beim Start eine Masse von 5511kg. Zu Beginn des Wiedereintritts hat sie dann nur noch ein Masse von $995$ kg, die sich durch den ReEntry-Burn auf die Trockenmasse von $727$ kg verringert.
\begin{figure}[h]
	\centering
