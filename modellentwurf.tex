...
Da sich an der Wanddicke $d$ im Laufe der FEM-Simulationen vermutlich am meisten ändern wird, wird hier zunächst einfach ein grober Wert abgeschätzt in dem ein Blick auf andere Grid Fins geworfen wird. Gemeinsam haben sie eigentlich alle, dass das Gitter fast vollständig die gleich Dicke besitzt und nur zu Einspannung hin an Stärke zunimmt. An dieser Stelle wird für den für die Wanddicke des Rahmens als auch des Gitters ein linearer Verlauf gewählt, der mit $d=3$mm an der Einspannung anfängt und am anderen Ende den Wert $0$mm annehmen würde. Da dies jedoch keine realistische Geometrie ergeben würde, wird dich Dicke auf einen Mindestwert von $1,5$mm beschränkt.
\begin{figure}[h]
	\centering
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.85\textwidth]{Halterung.png}
