...
\hyphenation{Dreh-rate}
\hyphenation{sta-tisch}
\hyphenation{da-r\"u-ber}
\hyphenation{Kraft-rich-tung}
\hyphenation{Air-Launch}
...
\logo{\includegraphics{iraslogo_deutsch.png}} % ilrlogo_englisch.png
\titlepicture{titelbild.png}
...
\begin{document}
  ...
  \includepdf[pages = 2] {aufgabenstellung}
  ...
  %
  %---------------------------------------------------
  			% fügt Symbolverzeichnis trotz * in das Inhaltsverzeichnis ein
 ...
 %\printglossaries 
  ...
  %---------------------------------
  \begin{appendix}
  	\include{materialtabelle}
  	\include{Halterung-Anhang}
  	\include{FEM-Anhang}
    %\include{projekt}
