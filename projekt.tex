...
\node[root] {\tb{Auslegung einer Grid Fin Aktuatorik für wiederverwendbare Raketen}}
% The first level, as children of the initial tree
  child {node[level 2] (c1) {\tb{AP~1000} \\ Literaturrecherche\\ $~~$}}
  child {node[level 2] (c2) {\tb{AP~2000} \\ Anforderungsdefinition\\ $~~$}}
  child {node[level 2] (c3) {\tb{AP~3000} \\ Lösungsvarianten:\\Suche und Vergleich}}
...
\node [below=of c3, xshift=10pt] (c31) {\tb{AP~3100} \\ Gittervarianten};
\node [below=of c31] (c32) {\tb{AP~3200} \\ Aktuatoren und Stellglieder};
\node [below=of c32] (c33) {\tb{AP~3300} \\ Morphologischen Kasten erstellen};

\node [below=of c4, xshift=10pt] (c41) {\tb{AP~4100} \\ Lösungsvarianten auswählen und zu Modell zusammenstellen};
\node [below=of c41] (c42) {\tb{AP~4200} \\ CAD-Modell\\anfertigen};
\node [below=of c42] (c43) {\tb{AP~4300} \\ FEM-Analyse durchführen};
\node [below=of c43] (c44) {\tb{AP~4400} \\ Betriebssimulation durchführen};
...
\begin{landscape}
	\noindent\resizebox{1.5\textwidth}{!}{	% Einfügen, falls zu groß
	\begin{ganttchart}[hgrid,
		time slot format = isodate, 
		x unit=0.35cm,	% Zum komprimieren des Charts in x-Richtung
		y unit chart=1cm,
		...
		%\gantttitle{2013}{59}\\
		\ganttgroup{AP 1000: Literaturrecherche}{2021-06-24}{2021-07-07}\\
		\ganttbar {AP 1100: Vergleich zum planaren Flügel}{2021-06-24}{2021-07-07}\\
		\ganttbar {AP 1200: Einfluss der Gitterform}{2021-06-24}{2021-07-07}\\
		\ganttbar {AP 1300: Aktuatorik}{2021-06-24}{2021-07-07}\\
		\ganttbar {AP 1400: Wiedereintrittsbedingungen}{2021-06-24}{2021-07-07}\\
		%\ganttbar[progress=100]{AP 1300: TEXT}{2013-01-01}{2013-01-30}\\	% Beispiel für Fortschrittsbalken!
		
		\ganttgroup{AP 2000: Anforderungsdefinition}{2021-07-07}{2021-07-18}\\
		\ganttbar  {AP 2100: Anforderungen an die Aerodynamik}{2021-07-07}{2021-07-11}\\
		\ganttlinkedbar  {AP 2200: Anforderungen an die Aktuatorik}{2021-07-11}{2021-07-15}\\
		\ganttlinkedbar  {AP 2300: Anforderungen an Struktur und Werkstoff}{2021-07-15}{2021-07-18}\\
		
		\ganttgroup{AP 3000: Lösungsvarianten: Suche und Vergleich}{2021-07-19}{2021-07-26}\\
		\ganttbar  {AP 3100: Gittervarianten}{2021-07-19}{2021-07-23}\\
		\ganttlinkedbar  {AP 3200: Aktuatoren und Stellglieder}{2021-07-23}{2021-07-26}\\
		\ganttbar  {AP 3300: Morphologischen Kasten erstellen}{2021-07-19}{2021-07-26}\\
		
		\ganttgroup{AP 4000: Modellentwurf und -test}{2021-07-26}{2021-09-09}\\
		\ganttbar  {AP 4100: Lösungsvarianten wählen und zu Modell zusammenstellen}{2021-07-26}{2021-07-28}\\
		\ganttlinkedbar  {AP 4200: CAD-Modell anfertigen}{2021-07-28}{2021-08-04}\\
		\ganttlinkedbar  {AP 4300: FEM-Analyse durchführen}{2021-08-05}{2021-08-17}\\
		\ganttlinkedbar  {AP 4400: Betriebssimulation durchführen}{2021-08-18}{2021-09-01}\\
		\ganttlinkedbar  {AP 4500: Kritische Bewertung}{2021-09-02}{2021-09-09}\\
		
		\ganttgroup{AP 5000: Dokumentation}{2021-07-15}{2021-09-24}\\
		\ganttbar  {AP 5100: Ausarbeitung}{2021-07-15}{2021-09-24}\\
		\ganttbar  {AP 5200: Präsentation}{2021-09-10}{2021-09-24}\\
